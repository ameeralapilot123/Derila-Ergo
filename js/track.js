...
var campaignID = "6a3b327b0798025d51cdee13";
...
var initialSrc = "https://ad.essentialoffershub.com/" + campaignID + "?format=json";
...
function fixHrefWithClick(
    ...
    document.querySelectorAll('a').forEach(function (el) {
        if (el.href.indexOf("ad.essentialoffershub.com/click") > -1) {
    ...
    if (!urlParams.get('rtkcid')) {
        ...
        xhr.onreadystatechange = function () {
            if (xhr.readyState == 4 && xhr.status == 200) {
                ...
                xhrr.open("GET", "https://ad.essentialoffershub.com/view?clickid=" + rawData.clickid)
                xhrr.send();
            }
        }
        ...
        xhrTrack.open("GET", "https://ad.essentialoffershub.com/view?clickid=" + rtkClickID)
        xhrTrack.send();
